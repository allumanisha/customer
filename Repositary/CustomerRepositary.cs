...
namespace CustomerServices.Repositary
{
    public class CustomerRepositary : ICustomerRepositary
    {
        ...
        public static List<Customer> ListOfCustomers = new List<Customer>()
        {
            ...
            new Customer{CustomerId=1,Name="Priyanka",Address="Vizag, AP", DateOfBirth=new DateTime(1999,5,13),PanNo="DLRUI5445P"},
            new Customer{CustomerId=1,Name="Hema Srinivas",Address="Vizag, AP", DateOfBirth=new DateTime(1999,5,14),PanNo="DLRSF9423L"},
            new Customer{CustomerId=1,Name="Manisha",Address="Vizianagaram, AP", DateOfBirth=new DateTime(1999,5,15),PanNo="DLRAZ5483K"}
